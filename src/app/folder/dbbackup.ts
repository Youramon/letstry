...
export const alleListenBUStr: {[key: string]: string} = {"chatting-apps": "chattingAppsBU","search-engines": "searchEnginesBU" , "streaming-unlimited": "streamingUnlimitedBU", "cloud-downloads": "cloudsBU", "youtube-social": "youtubeSocialsBU", "video-editors": "videoEditorsBU", "chatbots": "chatBotsBU", "email": "emailBU"};